...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      spacing: {
        'safe-left': 'max(var(--tw-spacing-4), env(safe-area-inset-left))',
        'safe-right': 'max(var(--tw-spacing-4), env(safe-area-inset-right))',
        'safe-top': 'max(var(--tw-spacing-4), env(safe-area-inset-top))',
        'safe-bottom': 'max(var(--tw-spacing-4), env(safe-area-inset-bottom))',
      },
      fontSize: {
