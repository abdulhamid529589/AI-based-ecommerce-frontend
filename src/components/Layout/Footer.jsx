          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-muted-foreground mb-6">
              {shopInfo.shopDescription ||
                'Premium Bedding & Textile Products. Discover amazing products with exceptional quality and service.'}
            </p>
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-muted-foreground">
                <Mail className="w-5 h-5 text-primary" />
                <span>{shopInfo.shopEmail}</span>
              </div>
              <div className="flex items-center space-x-3 text-muted-foreground">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-[hsla(var(--glass-border))]">
          ...
          <div className="text-center md:text-right">
            <p className="text-muted-foreground text-sm">
              © 2026 {shopInfo.shopName}. All rights reserved.
            </p>
